...
import styles from './css/jobsAccept.module.css';
...
function jobsAcceptedPage() {
    ...
    async function fetchData() {
        setOpen(true);
        try {
            const response = await axios.get(`${url}/api/studio/showWorkingJobs?working=accepted&search=${search}`, {
                headers: {
...
export default jobsAcceptedPage