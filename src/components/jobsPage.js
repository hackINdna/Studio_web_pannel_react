...
import styles from './css/jobsStyle.module.css';
...
function jobsPage() {
    ...
    async function fetchData() {
        setOpen(true);
        try {
            const response = await axios.get(`${url}/api/getStudioJob?search=${search}`, {
                headers: {
                ...
                <div className={styles.main_white}>
                    ...
                    <div className={styles.main_job_section}>
                        ...
                        {newUserData.length === 0 ? <div className={styles.main_image}>
                            ...
                            <span className={styles.text1}>You don't have any job added yet</span>
                            <span>Add any job</span>
